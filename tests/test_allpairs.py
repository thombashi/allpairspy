...
class Test_pairewise_list:
    ...
    def test_normal(self):
        ...
        assert list(AllPairs(parameters)) == [
            ...
            ["Brand Y", "98", "Modem", "Part-Time", 60],
            ["Brand Y", "2000", "Modem", "Salaried", 6],
            ["Brand X", "NT", "Internal", "Contr.", 10],
            ["Brand X", "98", "Internal", "Hourly", 10],
...
class Test_triplewise:
    ...
    def test_normal(self):
        ...
        assert list(AllPairs(parameters, n=3)) == [
            ...
            ["Brand X", "98", "Internal", "Hourly", 6],
            ["Brand Y", "2000", "Modem", "Part-Time", 6],
            ["Brand Y", "98", "Modem", "Part-Time", 60],
            ["Brand X", "XP", "Internal", "Part-Time", 10],
            ["Brand X", "XP", "Internal", "Contr.", 6],
            ["Brand X", "98", "Modem", "Salaried", 60],
            ["Brand X", "XP", "Modem", "Hourly", 15],
            ["Brand X", "98", "Internal", "Hourly", 30],
            ["Brand X", "XP", "Internal", "Contr.", 30],
            ["Brand X", "98", "Modem", "Salaried", 10],
            ["Brand X", "XP", "Modem", "Contr.", 60],
            ["Brand X", "98", "Internal", "Salaried", 30],
            ["Brand X", "XP", "Internal", "Salaried", 60],
            ["Brand X", "98", "Modem", "Contr.", 6],
            ["Brand X", "XP", "Modem", "Hourly", 10],
            ["Brand X", "98", "Internal", "Part-Time", 60],
            ["Brand X", "XP", "Internal", "Part-Time", 30],
            ["Brand X", "98", "Modem", "Hourly", 30],
            ["Brand X", "XP", "Modem", "Contr.", 15],
            ["Brand X", "98", "Internal", "Salaried", 15],
            ["Brand X", "XP", "Internal", "Salaried", 10],
            ["Brand X", "98", "Modem", "Contr.", 10],
            ["Brand X", "XP", "Modem", "Hourly", 6],
            ["Brand X", "98", "Internal", "Part-Time", 6],
            ["Brand X", "XP", "Internal", "Part-Time", 15],
            ...
            ["Brand Y", "2000", "Internal", "Salaried", 10],
            ["Brand Y", "2000", "Internal", "Contr.", 60],
            ["Brand Y", "NT", "Modem", "Salaried", 15],
            ["Brand Y", "NT", "Modem", "Hourly", 10],
            ["Brand Y", "NT", "Modem", "Part-Time", 10],
            ["Brand Y", "2000", "Modem", "Contr.", 15],
            ["Brand Y", "98", "Internal", "Contr.", 6],
            ["Brand X", "NT", "Modem", "Contr.", 6],
            ["Brand Y", "98", "Internal", "Salaried", 10],
            ["Brand X", "NT", "Internal", "Part-Time", 60],
            ["Brand Y", "98", "Internal", "Hourly", 30],
            ["Brand X", "NT", "Internal", "Salaried", 30],
            ["Brand Y", "98", "Internal", "Hourly", 15],
            ["Brand X", "NT", "Internal", "Part-Time", 10],
            ["Brand Y", "XP", "Internal", "Contr.", 60],
            ["Brand X", "2000", "Internal", "Contr.", 6],
            ["Brand Y", "XP", "Modem", "Part-Time", 6],
            ["Brand Y", "XP", "Internal", "Hourly", 15],
            ["Brand X", "2000", "Modem", "Salaried", 60],
...
class Test_pairewise_w_tested:
    ...
    def test_normal(self):
        ...
        assert list(AllPairs(parameters, previously_tested=tested)) == [
            ...
            ["Brand Y", "XP", "Internal", "Hourly", 15],
            ["Brand Y", "NT", "Modem", "Part-Time", 6],
            ["Brand X", "2000", "Internal", "Contr.", 10],
            ["Brand X", "NT", "Internal", "Hourly", 30],
            ["Brand Y", "XP", "Modem", "Salaried", 10],
            ["Brand Y", "98", "Modem", "Part-Time", 15],
            ["Brand X", "2000", "Internal", "Hourly", 60],
            ["Brand X", "98", "Internal", "Contr.", 6],
